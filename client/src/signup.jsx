  ...
  const SetData = async () => {
    try {
      ...
      if (!signup.uname || !signup.mono || !signup.email || !signup.pass || !signup.cpass) {
        ...
        const res = await axios.post('http://localhost:3000/api/setData', signup)
    ...
    <>
      <div id="Scontainer">
        ...
        <div><label>Username : </label><br />
          <input type="text" placeholder='Enter your username' value={signup.uname}
            name="uname" onChange={handleInput} /></div>

        <br /> <br />

        <div><label>Mobile No. : </label><br />
          <input type="text" placeholder='Enter your Mobile No.' value={signup.mono}
            name="mono" onChange={handleInput} /></div>
        <br /> <br />

        <div><label>Email : </label><br />
          <input type="text" placeholder='Enter your Mobile No.' value={signup.email}
            name="email" onChange={handleInput} /></div>
        <br /> <br />

        <div><label>Password : </label><br />
          <input type="text" placeholder='Enter your Mobile No.' value={signup.pass}
            name="pass" onChange={handleInput} /></div>
        <br /> <br />

        <div><label> Confirm Password : </label><br />
          <input type="text" placeholder='Enter your Mobile No.' value={signup.cpass}
            name="cpass" onChange={handleInput} /></div>
        <br /> <br />
